...
function generateResume() {
    let opt = {
        margin: 0,
        filename: document.body.classList.contains(darkTheme) ? 'myResumeCV-dark.pdf' : 'myResumeCV-light.pdf',
        image: { type: 'jpeg', quality: 0.98 },
        html2canvas: { scale: 3, useCORS: true }, // scale más alto = mejor definición
